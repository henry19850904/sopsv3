...
(function (b) { "function" === typeof define && define.amd ? define(["jquery", "datatables"], function (a) { return b(a, window, document) }) : "object" === typeof exports ? module.exports = function (a, e) { a || (a = window); if (!e || !e.fn.dataTable) e = require("datatables")(a, e).$; return b(e, a, a.document) } : b(jQuery, window, document) })(function (b, a, e) {
    var d = b.fn.dataTable; b.extend(!0, d.defaults, { dom: "<'row'<'col-sm-6'><'col-sm-6'f>><'row'<'col-sm-12'tr>><'row'<'col-xs-2'l><'col-xs-3'><'col-xs-7'p>>", renderer: "bootstrap" }); b.extend(d.ext.classes,
